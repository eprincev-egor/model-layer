...
function prepareValue(description, key, value) {
    ...
    if ( description.type == "number" ) {
        value = Model.prepareNumber(key, value);
        ...
        value = Model.prepareString(key, value);
        ...
        value = Model.prepareBoolean(key, value);
        ...
        value = Model.prepareDate(key, value);
    }
...
Model.prepareNumber = function prepareNumber(key, value) {
...
Model.prepareString = function prepareString(key, value) {
    if ( 
        _.isNaN(value) ||
        value === false ||
        value === true ||
...
Model.prepareBoolean = function prepareBoolean(key, value) {
    if ( 
        _.isNaN(value) ||
        _.isObject(value) ||
        _.isArray(value) ||
...
Model.prepareDate = function prepareDate(key, originalValue) {
